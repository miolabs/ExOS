...
#include <support/canopen/canopen.h>
static CANOPEN_INSTANCE _canopen;
static const CANOPEN_NODE_IDENTITY _canopen_identity = { 
	.DeviceType = CANOPEN_ID('H', 'O', 'S', 'T'),
	.VendorID = CANOPEN_ID('M', 'I', 'O', 'R'),
