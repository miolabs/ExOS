...
void __weak SAI2_IRQHandler();
void __weak QUADSPI_IRQHandler();
void __weak LPTIMER1_IRQHandler();
void __weak HDMI_IRQHandler();
void __weak I2C4_EV_IRQHandler();
void __weak I2C4_ER_IRQHandler();
void __weak SPDIFRX_IRQHandler();
void __weak DSI_IRQHandler();
void __weak DFSDM1_FLT0_IRQHandler();
void __weak DFSDM1_FLT1_IRQHandler();
void __weak DFSDM1_FLT2_IRQHandler();
void __weak DFSDM1_FLT3_IRQHandler();
void __weak SDMMC2_IRQHandler();
void __weak CAN3_TX_IRQHandler();
void __weak CAN3_RX0_IRQHandler();
void __weak CAN3_RX1_IRQHandler();
void __weak CAN3_SCE_IRQHandler();
void __weak JPEG_IRQHandler();
void __weak MDIOS_IRQHandler();
...
#pragma weak LPTIMER1_IRQHandler = Default_Handler
#pragma weak HDMI_IRQHandler = Default_Handler
#pragma weak I2C4_EV_IRQHandler = Default_Handler
#pragma weak I2C4_ER_IRQHandler = Default_Handler
#pragma weak SPDIFRX_IRQHandler = Default_Handler
