#ifndef STM32F7_USB_OTG_HS_H
#define STM32F7_USB_OTG_HS_H
...
typedef struct 
{
	...
	volatile unsigned long PHYCR;	// NOTE: 0x034 (undocumented)	
...
#define OTG_HS_GAHBCFG_GINTMASK (1<<0)
#define OTG_HS_GAHBCFG_TXFELVL (1<<7)
#define OTG_HS_GAHBCFG_PTXFELVL (1<<8)
