...
#define MPU6050_ADDRESS MPU6050_ADDRESS_AD0_LOW //Default
...
#define MPU6050_OFFS_TC 0x02 //[7] PWR_MODE, [6:1] ZG_OFFS_TC, [0] OTP_BNK_VLD
...
} BLE_MPU6050_REPORT_DATA;

typedef struct
{
	unsigned char Data[6];
} BLE_ACEL_REPORT_DATA;

typedef struct
{
	unsigned char Data[6];
} BLE_GYRO_REPORT_DATA;

typedef struct
{
	unsigned char Data[1];
} BLE_MPU_TRANSMIT_DATA;
