...
#if defined BOARD_XKUTY_CPU1_PROTO
...
#define OUTPUT2_MASK (EBRAKE_MASK)
#define OUTPUT2_IDLE_MASK (EBRAKE_MASK)

#define OUTPUT3_PORT LPC_GPIO3
#define LED_MASK (1<<0)
#define OUTPUT3_MASK (LED_MASK)
...
#elif defined BOARD_XKUTY_CPU1_EXTENDED
...
#if defined BOARD_XKUTY_CPU1_PROTO || defined BOARD_XKUTY_CPU1_EXTENDED
